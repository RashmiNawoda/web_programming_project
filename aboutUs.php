...
>>>>>>> a071aab97e75b0d6724e7a7e21a1e58fd574a5cf:aboutUs.php
...
<<<<<<< HEAD:aboutUs.html
      ...
      <p>
        At car-ing, we are dedicated to providing top notch car maintanance and
        repair services to keep your vehicle in excellent condition.With years
        of exprience in the industry, we pride ourselves on delivering
        exceptional quality and unmatched customer service.
      </p>
      <!--mission-->
      <h2>Our Mission</h2>
      <p>
        Our mission is to ensure the safety and satisfaction of every customer
        by offering reliable, efficient and affordable car servicing.
      </p>
      <!--vision-->
      <h2>Vision</h2>
      <p>Building long lasting relationships based on trust and excellence.</p>
      <!--Team member-->
      <h3>Team Members</h3>
      <p>
        Sadia - Lead Mechanic , Shuvo - Service Manager, Nikhil - Customer
        Suuport, Rashmi - Customer Suuport.
      </p>
=======
        <header class="aboutusheader">
            <h1>About us</h1>
